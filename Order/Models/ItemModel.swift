...
class ItemModels: NSObject{
	...
	var CONST_DEMODATAS : [ItemModel] = [
		...
		ItemModel(_code: "Item_101", _name: "から揚げ定食", _tanka: 110, _photo: UIImage(named: "から揚げ定食.jpg")!, _category:1),
		ItemModel(_code: "Item_102", _name: "鮭の定食", _tanka: 210, _photo: UIImage(named: "鮭の定食.jpg")!, _category:1),
		ItemModel(_code: "Item_103", _name: "焼肉定食", _tanka: 310, _photo: UIImage(named: "焼肉定食.jpg")!, _category:1),
		ItemModel(_code: "Item_104", _name: "生姜焼き定食", _tanka: 410, _photo: UIImage(named: "生姜焼き定食.jpg")!, _category:1),
